...
<template>
  ...
  >
    <div class="px-4 md:px-8 lg:px-16 xl:px-0">
      <h1 class="text-base font-bold md:text-lg xl:text-2xl">Web 3.0</h1>
    </div>
    <div
      class="flex gap-4 px-4 lt-sm:flex-col md:px-8 lg:px-16 md:overflow-x-scroll md:snap-x xl:px-0 xl:grid xl:grid-cols-2 md:gap-16"
    >
      <div
