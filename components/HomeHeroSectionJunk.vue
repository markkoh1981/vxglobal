...
<template>
  <div
    ...
    class="absolute bottom-0 flex flex-col space-y-8 justify-end lt-xl:left-4 md:-bottom-8 xl:bottom-24 lt-md:items-center md:px-16 md:space-y-16 2xl:w-7xl 2xl:self-center"
  >
