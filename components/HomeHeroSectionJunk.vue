...
<template>
  <div
    ...
    class="absolute bottom-0 flex flex-col space-y-8 justify-end lt-md:left-0 md:-bottom-8 xl:bottom-24 lt-md:items-center lt-md:px-4 lt-xl:px-16 md:space-y-16 2xl:w-9/10 2xl:self-center"
  >
